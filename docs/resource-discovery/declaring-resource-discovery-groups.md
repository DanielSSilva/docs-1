...
- `type` - Type of Azure resources that must be discovered, see "[Supported Azure Services](https://docs.promitor.io/v2.7/scraping/overview/?h=supported+azure+services#supported-azure-services)" for a full list of supported types. *(Required)*
